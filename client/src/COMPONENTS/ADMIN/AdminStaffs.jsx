...
import staffStyle from "../Staffs.module.css";
import cx from "classnames";
import infoStyle from "../MyInfo.module.css";


class AdminStaffs extends Component{
    constructor(){
        super();
        this.state = {
            staffs: [],
    ...
    setCurrentPage = () => {
        ...
        let elements = staffs.slice(offset, offset + perPage).map(staff => (
            <li className={cx(staffStyle.listCon,"col-md-6 col-lg-4")} key={staff.username}>
                <AdminUserCard
    ...
    render(){
        ...
        if(pageCount > 1){
            paginationElement = (
                    ...
                    previousLinkClassName={staffStyle.paginateLink}
                    nextLinkClassName={staffStyle.paginateLink}
                    disabledClassName={"disabled"}
                    activeClassName={staffStyle.paginateActive}
                    pageLinkClassName={staffStyle.paginateLink}
            ...
            <div className="container">
                { !isLoaded ? 
                    ...
                    <div>
                        ...
                        <hr/>
                        {paginationElement}
                        <ul className={cx(staffStyle.listCon,"row")}>
                            {elements}
                        </ul>
                        {paginationElement}
                    </div>
